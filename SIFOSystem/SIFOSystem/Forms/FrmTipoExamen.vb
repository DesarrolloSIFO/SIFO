...
Public Class FrmTipoExamen
    ...
    Private Sub ActualizarExamenCliente()
        ...
        Using CMd As New SqlCommand
            ...
            Catch ex As Exception
                MessageBox.Show("Error al Actualizar los datos", "SIFO", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Finally
                Cn.Close()
            End Try
        End Using
    ...
    Private Sub EditarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EditarToolStripMenuItem.Click
        ...
        TxtOI.Text = LsvExamenCliente.FocusedItem.SubItems(2).Text
        TxtOD.Text = LsvExamenCliente.FocusedItem.SubItems(3).Text
        TxtAdicion.Text = LsvExamenCliente.FocusedItem.SubItems(4).Text
        TxtDistanciaPupilar.Text = LsvExamenCliente.FocusedItem.SubItems(5).Text
        CboTipoExamen.Text = LsvExamenCliente.FocusedItem.SubItems(6).Text
        CboUsuario.Text = LsvExamenCliente.FocusedItem.SubItems(7).Text
